...
<template>
  <div class="comp_container param_form_dialog_comp">
    <el-dialog
      v-model="showDialog"
      width="450px"
      top="15vh"
    ...
    >
      ...
      <el-form class="form" ref="paramFormRef" :model="formData" :rules="formDataRules" label-width="auto">
