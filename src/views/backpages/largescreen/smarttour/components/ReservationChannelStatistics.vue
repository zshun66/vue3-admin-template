<script setup name="ReservationChannelStatistics">
const data = [
...
const option = ref({
  ...
  series: [
    ...
    },
    {
      ...
      label: { show: false },
      labelLine: { show: false },
      data: new Array(150).fill('').map((_val, index) => {
        if (index % 3 === 0) {
          return {
...
<template>
  <div class="comp_container reservation_channel_statistics_comp">
    <div class="title_box">
...
.reservation_channel_statistics_comp {
  width: 100%;
  height: 30%;
  min-height: 260px;
